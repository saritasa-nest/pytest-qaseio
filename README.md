...
[![Build Status](https://github.com/saritasa-nest/pytest-qaseio/workflows/test/badge.svg?branch=main&event=push)](https://github.com/saritasa-nest/pytest-qaseio/actions?query=workflow%3Atest)
...
* Extended error report (screenshot, html and browser logs)
* Strict case ids validations
* Instead of case ids, we use direct links to cases
...
Then just plug in `pytest_qaseio.plugin`:

```python
# conftest.py

pytest_plugins = (
    "pytest_qaseio.plugin",
)
```
